      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2 max-w-md">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-gold-500 to-gold-600 flex items-center justify-center font-display text-ink-950 text-lg font-semibold">
              Y
            </div>
          ...
          <Link
            to="/contact"
            className="mt-6 inline-flex items-center gap-2 text-gold-400 text-sm font-medium hover:text-gold-300"
          >
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <a href="tel:+10000000000" className="inline-flex items-center gap-2 text-white/70 hover:text-white">
                <Phone size={14} className="text-gold-400" /> Call or text
              </a>
            </li>
            <li>
              <a href="mailto:hello@youssef.studio" className="inline-flex items-center gap-2 text-white/70 hover:text-white">
                <Mail size={14} className="text-gold-400" /> hello@youssef.studio
              </a>
            </li>
          </ul>
        </div>
